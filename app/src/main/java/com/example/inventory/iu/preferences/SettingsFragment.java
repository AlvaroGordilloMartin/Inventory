...
public class SettingsFragment extends PreferenceFragmentCompat implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        //Se quiere recoger el evento OnsharedPreferencedchanged cuando la preferencia lista cambie
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        //La preferencia que ha lanzado el evento es la lista por lo tanto podemos hacer un downcasting
        ListPreference listPreference = (ListPreference)preference;

        //Vamos a obtener el indice del valor seleccionado en sharedPreferences
